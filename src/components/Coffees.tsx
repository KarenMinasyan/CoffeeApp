                    ...
                    <View style={styles.rating}>
                      <BlurView overlayColor={"#1f2126"}>
                        <View style={styles.star}>
                          <Icon style={styles.starIcon} name="star" size={SPACING * 1.7} color={COLORS.primary} />
                          <Text style={styles.rate}>{coffee.rating}</Text>
                        </View>
                      </BlurView>
                    </View>
                  </TouchableOpacity>
                  <Text style={styles.title} numberOfLines={2}>{coffee.name}</Text>
                  <Text style={styles.included} numberOfLines={1}>{coffee.included}
                  </Text>
